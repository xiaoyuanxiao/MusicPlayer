...
public class AudioPlayActivity1 extends BaseActivity implements IAudioPlayView, View.OnClickListener {
...
//        audioPlayBinding.tvAudioplayEndtime.setText("-" + timelength / 60 + ":" + s);
        ...
        audioPlayBinding.seekbarAudioplay.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
                    ...
                    mediaPlayer.seekTo(progress);// 设置音频到  xxx毫秒
    ...
    private void initMedia() {
       ...
       // int currentPosition = mediaPlayer.getCurrentPosition();//已经播放到毫秒数量
        ...
        mediaPlayer.setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() {
            ...
            public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i1) {
                ...
                audioPlayBinding.seekbarAudioplay.setProgress(duration);
//                audioPlayBinding.tvAudioplayEndtime.setText(duration/1000);
        ...
        try {
            mediaPlayer.setDataSource(AudioPlayActivity1.this, uri);
            Log.e("url============",url+"");
            mediaPlayer.prepare();
            mediaPlayer.start();
