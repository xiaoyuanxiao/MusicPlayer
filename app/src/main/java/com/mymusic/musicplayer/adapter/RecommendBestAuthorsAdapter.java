...
public class RecommendBestAuthorsAdapter extends RecyclerView.Adapter<RecommendBestAuthorsAdapter.ViewHolder> {
    List<RecommendationBean.BestAuthorsBean> list;

    public RecommendBestAuthorsAdapter(List<RecommendationBean.BestAuthorsBean> list) {
        this.list = list;
    }
