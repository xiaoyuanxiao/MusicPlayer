...
public class TestaaAdapter extends RecyclerView.Adapter<TestaaAdapter.ViewHolder> {
    List<RecommendationBean.NewArrivalsBean> list = new ArrayList<>();

    public TestaaAdapter(List<RecommendationBean.NewArrivalsBean> list) {
